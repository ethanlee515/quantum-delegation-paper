...
The fact that almost all quantum supremacy tasks (e.g.,~\cite{Boson, IQP, nature-google}) are sampling ones strengthens the importance of delegation for quantum sampling problems.
 ...
 \Ethan{Maybe replace the following sentence with the actual challenges? Ie. unclear how to run many copies to reduce errors; classical approach with PRG seed doesn't work either}

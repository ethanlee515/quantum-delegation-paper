...
A protocol for classical sampling problems is usually obtained from one for decision problems,
...
where the outcome is generally different from one execution to the next.
Furthermore, it is unclear how to even amplify the soundness of a sampling protocol by means of repetitions,
especially considering the outputs from different executions might be correlated to begin with.

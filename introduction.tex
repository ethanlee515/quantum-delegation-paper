...
Our first observation is that the sampling version of $\BQP$ (e.g., as formulated by Aaronson~\cite{aaronson_2013}) might be a more appropriate notion to serve the purpose of the original problem. 
Philosophically, experiments of quantum mechanics usually generate samples and statistical information, which is well demonstrated in the famous double-split 

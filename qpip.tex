...
\begin{proof}
	...
	Let $q_i$ be the accept probability of at least $(\frac{1}{2}-\varepsilon)n$ copies out of $\rho_i^{\otimes n}$ accept under \autoref{AlgGroundStateCheck}. By Bayes' theorem, conditioned on acceptance, the probability of the input being $\ket{\rho_i^{\otimes n+m}}$ is then $\frac{w_i q_i}{\sum_j w_j q_j}$.

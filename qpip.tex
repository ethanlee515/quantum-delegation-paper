...
\Ethan{Maybe this is less work than defining a general ``efficient verifier", since $\BQP$ and $\SampBQP$ have different inputs}
We now show its completeness and soundness.
  
\begin{thm}
    \label{QPIP1thm}
	$\PiSamp$ has negligible completeness error and is statistically sound.
	\Ethan{TODO Fix this. Figure out where to put the inverse poly dependence between lambda and eps.}
\end{thm}
\begin{prf}

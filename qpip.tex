...
\begin{protocol}{$\QPIP_1$ protocol for $\SampBQP$}
	\label{ProtoQPIP1}
	Let $\varepsilon=T^{-c}$. \Ethan{Try setting up this $\varepsilon$ more intuitively}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\begin{enumerate}
				...
				\item If the measurement result of the clock register $\geq\frac{T}{2}$ and $y=\bot$, then set $y$ as the measurement result of the data register.
			\end{enumerate}

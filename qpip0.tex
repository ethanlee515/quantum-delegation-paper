...
\Ethan{Next sentence feels like a technical detail that fits better in a proof?}
$G_{0,i}$ and $G_{1,i}$ need to be efficient because $\PiMeasure$ only gives computational security.
\Ethan{There's gotta be a better way to describe the following...}
...
\Ethan{Maybe move the above chunk below the lemma and just explain by doing} 

    ...
    \begin{enumerate}
        ...
        \item \label{step:urmila-in-naive}
            ...
            \begin{enumerate}
                ...
                \item\label{step:c-urmila-in-naive} The verifier samples $c\leftarrow\cVNaive{3}()$ \Ethan{Just give it sec. param even though it's just a public coin. Just so it doesn't look strange.} and sends it to the prover.

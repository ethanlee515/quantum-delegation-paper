...
Protocol:
\begin{enumerate}
	\item The verifier generates $m$ independently copies of basis choices $\vec{h}=(h_1,\ldots,h_m)$ on inputs $1^\lambda, 1^{1/\varepsilon}, x$. \Ethan{As in step A of proto B...}
	\item The prover prepares $\rho^{\otimes m}$. \Ethan{Same as last pt.}
	...
	\item The prover generates $\vec{a}$ on inputs $\vec{pk}, \vec{c}, \sigma$ and sends it back to the verifier.

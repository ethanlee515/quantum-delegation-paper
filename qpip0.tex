...
\begin{align}
    z_{commit,alt} \approx~{c,\eps} M_{XZ}(\rho_{alt},h)
\end{align}
...
% $$ \ket{\psi}_{\regX,\regZ} =  G_{0,i,\gamma}\ket{\psi}_{\regX,\regZ}+ G_{1,i,\gamma}\ket{\psi}_{\regX,\regZ}+\ket{\psi_{err}}_{\regX,\regZ},$$
  ...
  \Ethan{check whether this should be some single pk and y or the entire tuple}
...
\Ethan{TODO There are typos in the proof}
\end{proof}

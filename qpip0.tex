...
\Ethan{This proof currently only shows $O(\varepsilon)$ accuracy, which doesn't perfectly match up with the definition. Hopefully doesn't matter way too much though?}

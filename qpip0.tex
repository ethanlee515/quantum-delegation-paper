...
\begin{proof}
    ...
    Conditioned on $\PNaiveStar$ reject, since dummy strategy will be rejected with high probability in Hadamard round, \Ethan{kinda obvious but we never explicitly explained why}

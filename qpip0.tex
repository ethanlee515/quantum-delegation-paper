...
For every prover strategy $(U_0,U)$ for Protocol~\ref{proto:QPIP0samp} and $i\in [m]$, consider the following prover strategy for Protocol~\ref{proto:urmila4}: on the first round, try to create $\ket{\psi_{???}}$ \hannote{which $i$ do i use?}

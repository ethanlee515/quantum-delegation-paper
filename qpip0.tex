...
Putting together Equation~\ref{eq:z-z-good2}\ref{eq:z-good-rho}\ref{eq:rho-c}, and Remark~\ref{rmk:trace-to-comp} and Lemma~\ref{lem:computational-triangle0}, we have  
\begin{align}

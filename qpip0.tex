...
\Ethan{Probably can omit details from below}
...
\Ethan{Might need to fix the following. Note that it's not a standard parallel rep, so we can't just say it's N-fold parallel rep without saying anything else}

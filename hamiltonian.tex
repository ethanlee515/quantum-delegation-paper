...
\Ethan{TODO Give a bit of overview on what is this (I.e. QMA-completeness and whatnot)}

This section will mostly be a summarization of known results related to adiabatic quantum computation found in sources such as \cite{adiabatic}. \Ethan{This source was given to us by Yu-Ching; I haven't read it}

\Ethan{TODO Say something about wanting to do more with $\QMA$ certificates than just check yes/no-instances}
...
\Ethan{Now say something about QMA here...}

We denote the set of $5$-local tensor products of $X$ and $Z$ gates as $\mathcal{G}_{XZ}$. \Ethan{mention it's the basis for 5-local Hamiltonians?}

...
\begin{thm}
	...
	\begin{enumerate}
		...
		each $H_i \in \LHXZ{6}$ and $|\alpha_i| \in O(T^4)$. Moreover, there are at most $O(T)$ non-zero terms. 
...
\] 
\XW{todo from here; might need to change the theorem statement as well}
...
\XW{rewrite this part of the introduction}

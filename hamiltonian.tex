...
In this section, we give a reduction from $\SampBQP$ to a local Hamiltonian problem. \hannote{proofs in later sections?}
...
\begin{theorem}
	Given a circuit $C$ consisting of Hadamard and Toffoli gates, and an input string $x$, there ea $\BPP$ machine can construct a description of $H_{C(x)}$ in polynomial time.
\end{theorem}

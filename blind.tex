...
\begin{thm}
    Assuming the QLWE assumption, \Ethan{wording sounds awkward? Maybe ``under the QLWE assumption"...?} there exists a blind, four-message $\QPIP_0$ protocol for all languages in $\BQP$ with negligible completeness and soundness errors.
\end{thm}

...
\begin{theorem}
	When \autoref{AlgAmp1} accepts an input with probability greater than $\delta$, its output when accepted has less than $\frac{p}{\delta}$ probability to be rejected by $\mathcal{F}$.
\end{theorem}
\begin{proof}

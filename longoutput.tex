...
\KM{just use $n$ qubit input. no need to distinguish input vs ancilla at this point}
...
\begin{proof}
\KM{prove what you claimed in the theorem.}
...
\KM{again, we don't need to make anccila explicit here}
\begin{theorem}
	...
	\begin{itemize}
		...
		\item \KM{TODO} $\braket{\phi|H_{circuit}|\phi}\geq\frac{3}{4}$ for $\ket\phi$ such that $\braket{\phi|\psi_{circuit}}=0$

...
\begin{proof}
	...
	Let $q_i$ be the accept probability of $\ket{\rho_i^{\otimes n+m}}$ under \autoref{AlgAmp1}. 

	By Bayes' theorem, conditioned on acceptance, the probability of the input being $\ket{\rho_i^{\otimes n+m}}$ is then $\frac{w_i q_i}{\sum_j w_j q_j}$.

...
\begin{proof}
	...
	Fix $\delta<2\Delta$ and partition the multi-indices into three types.
	...
	Apply Chernoff bound to $\frac{1}{2}-\delta$. There is overwhelming probability that...
	By Chernoff bound, there is overwhelming probability that...  Then we can write the input (?) as follows.

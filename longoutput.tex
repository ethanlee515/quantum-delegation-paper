...
$$\mathcal{F}\circ H=H\circ\mathcal{F}$$
...
\begin{itemize}
	\item Initial state is real
	\item Contains only Hadamard and Toffoli gates
	\item The last $\gamma$ of the gates are all identity gates (can achieve easily by padding)
\end{itemize}
...
Which according to \cite{2002quant.ph.10077A} is relevant to theory of random walks. Particularly, it has positive eigenvalues.

...
\begin{theorem}
Let $H$ be a local Hamiltonian with the following properties:
\begin{itemize}
	\item Ground state...?
	\item $\frac{3}{4}$?
\end{itemize}
Then, (some theorem statement)
\end{theorem}
\begin{proof}
	Let $\phi_i$ be the eigenbasis of $H$. Then we can decomposite what the prover sends the verifier as $$\sum_I \alpha_I \ket{\phi_{i_1}}\otimes\ket{\phi_{i_2}}\otimes\ldots\otimes\ket{\phi_{i_{TODO}}}$$.
\end{proof}

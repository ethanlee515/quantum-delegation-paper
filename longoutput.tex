...
\begin{proof}
	...
	Apply \autoref{AlgGroundStateCheck} to every register of $\ket{\phi_1^{\otimes n}}$. By Chernoff bound, there is overwhelming (as $n$ grows) probability that more than $Bn$ registers are accepted. On the other hand, take $J\in\mathcal{I}_3$ and do the same to every register of $\ket{\phi_J}$. By Chernoff bound, there is overwhelming probability that less than $Bn$ registers are accepted.

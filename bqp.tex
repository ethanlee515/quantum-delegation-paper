...
\begin{thm}
	\protoref{BQP} is a $\QPIP_1$ and constant round protocol for $\BQP$ with negligible completeness and soundness.
\end{thm}
...
\begin{protocol}{Blind Protocol for $\BQP$}
	...
	\begin{enumerate}
		...
		\item The verifier measures the incoming ciphertext according to \autoref{decodeMeasureOrder} and how it would've checked the $\QMA$ certificates \Ethan{Not sure if rigorous enough}
...
\begin{rmk}
	The same construction works for $\FBQP$ too. \Ethan{maybe say more?}
\end{rmk}

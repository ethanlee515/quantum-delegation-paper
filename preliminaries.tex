...
We define the sampling version of $\BQP$ based on \cite{aaronson_2013, aaronson_arkhipov_2011}.
The definition of $\SampBQP$ allows inverse-polynomial error in order to capture some characteristics of optics-based quantum computing implementations.

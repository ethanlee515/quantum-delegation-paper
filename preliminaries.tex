...
We use the projection lemma from \cite{kempe_kitaev_regev_2006}, which relates the ground state of Hamiltonians $H_1 + H_2$ with the ground state of $H_1\big|_{\ker H_2}$.

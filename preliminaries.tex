...
\begin{definition}
	...
	We say $\Pi$ is a protocol for the sampling problem $(D_x)_{x\in\zo^*}$ with completeness error $c$ and computational soundness \Ethan{Specify it's computational or no?} if for all $x\in\zo^*$:
	\begin{itemize}

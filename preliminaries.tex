...
It is worth noting that quantum states live in a Hilbert space which is continuous,
so it is likely that any physical implementation of quantum computing would naturally involve some sort of errors.
\cite{aaronson_arkhipov_2011} gives an argument from the physical implementation perspective that this error should be inverse polynomial.

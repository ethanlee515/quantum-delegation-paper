...
When the client has limited quantum capabilities, this is a ``streaming" model.
...
We do not care about rounds-complexity unless the client is fully classical,
in which case this model specializes to the standard rounds-based model.
...
\begin{definition}
    ...
    \begin{itemize}
		...
		\item (Computational soundness): \Ethan{TODO write in terms of comp. indistinguishability?}

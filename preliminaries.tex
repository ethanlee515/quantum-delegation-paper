...
\begin{thm}
	...
	\begin{itemize}
		...
		\item \Ethan{Is this obvious from the construction or do we need proof here?} Let $\Lambda$ be a product of $X$ and $Z$ measurements. Then there exists $\Lambda'$ product of $X$ and $Z$ measurements and $\widehat{\mathsf{QHE.Dec}}$ a BPP algorithm so that

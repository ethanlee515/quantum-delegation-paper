...
\begin{thm}
	...
	\begin{itemize}
		...
		\item \Ethan{I think this point is obvious?} Let $\Lambda$ be a product of $X$ and $Z$ measurements. Then there exists $\Lambda'$ product of $X$ and $Z$ measurements and $\widehat{\mathsf{QHE.Dec}}$ a BPP algorithm so that

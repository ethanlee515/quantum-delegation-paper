...
\label{def:comp-indis}
    ...
    We also extend it to classical random variable by treating them as mixed states.
\end{definition}

%   We extend computational indistinguishability to subnormalized states by taking the distinguisher $\mathsf{D}$ to output\hannote{?} subnormalized states as appropriate.

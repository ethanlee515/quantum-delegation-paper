...
\begin{dfn}
	TODO Need to define $\BQP$, $\QMA$, and $\FBQP$.
\end{dfn}
...
\Ethan{TODO maybe describe what it does? There was some catch-phrase in one of the paper that says ``??? implies independence" I think}
\begin{thm}
	\label{deFinetti}

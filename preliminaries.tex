...
\begin{dfn}
	Let $(\bbP, \bbV)(x)$ be an interactive protocol with the verifier's initial input being $x$. Then it is IND-CPA secure if, for any $x_1, x_2$, any polynomial time adversary $\cA$,
	$$\abs{\Pr\left[TODO\right]}-TODO$$
